...
#define INSTPAT_MATCH(s, name, type, ... /* execute body */ ) { \
  ...
  //INSTPAT("0000001 ????? ????? 001 ????? 01100 11", mulh   , R,printf("src1=%lx\n",SEXT(src1,32));int64_t a=(int64_t)src1;printf("a=%lx\n",a); int64_t tmp =(int64_t)a; printf("tmp=%lx\n",tmp);R(rd)=BITS(tmp,63,32) );
