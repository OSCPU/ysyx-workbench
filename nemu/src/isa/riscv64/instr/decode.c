...
//def_INSTR_IDTAB("??????? ????? ????? ??? ????? 00000 11", I     , load);
  ...
  def_INSTR_IDTAB("??????? ????? ????? 010 ????? 00000 11", I     , lw);
  ...
  def_INSTR_IDTAB("??????? ????? ????? 010 ????? 01000 11", S     , sw);
...
//def_INSTR_IDTAB("??????? ????? ????? ??? ????? 01100 11", R     , r_ty);
  ...
  def_INSTR_IDTAB("??????? ????? ????? 001 ????? 01100 11", R     , sll);
  def_INSTR_IDTAB("??????? ????? ????? 010 ????? 01100 11", R     , slt);
  def_INSTR_IDTAB("??????? ????? ????? 011 ????? 01100 11", R     , sltu);
  def_INSTR_IDTAB("??????? ????? ????? 100 ????? 01100 11", R     , xor);
  def_INSTR_IDTAB("0000000 ????? ????? 101 ????? 01100 11", R     , srl);
  def_INSTR_IDTAB("0100000 ????? ????? 101 ????? 01100 11", R     , sra);
  def_INSTR_IDTAB("??????? ????? ????? 110 ????? 01100 11", R     , or);
  def_INSTR_IDTAB("??????? ????? ????? 111 ????? 01100 11", R     , and);

//def_INSTR_IDTAB("??????? ????? ????? ??? ????? 00100 11", I     , i_ty);
  def_INSTR_IDTAB("??????? ????? ????? 000 ????? 00100 11", I     , addi);
  def_INSTR_IDTAB("??????? ????? ????? 001 ????? 00100 11", I     , slli);
