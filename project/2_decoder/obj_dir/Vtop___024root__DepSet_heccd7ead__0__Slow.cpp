...
#endif
                VL_FATAL_MT("vsrc/top.v", 51, "", "Settle region did not converge.");
            }
...
VL_ATTR_COLD void Vtop___024root___stl_sequent__TOP__0(Vtop___024root* vlSelf) {
    ...
    // Body
    vlSelf->seg = (0xffU & (~ (IData)(vlSelf->top__DOT__i2__DOT__y)));
    vlSelf->led = vlSelf->top__DOT__y;
}
...
VL_ATTR_COLD void Vtop___024root___dump_triggers__act(Vtop___024root* vlSelf) {
    ...
    if (vlSelf->__VactTriggered.at(1U)) {
        VL_DBG_MSGF("         'act' region trigger index 1 is active: @([changed] flag or [changed] top.y)\n");
    }
}
#endif  // VL_DEBUG
...
VL_ATTR_COLD void Vtop___024root___dump_triggers__nba(Vtop___024root* vlSelf) {
    ...
    if (vlSelf->__VnbaTriggered.at(1U)) {
        VL_DBG_MSGF("         'nba' region trigger index 1 is active: @([changed] flag or [changed] top.y)\n");
    }
}
#endif  // VL_DEBUG
...
VL_ATTR_COLD void Vtop___024root___ctor_var_reset(Vtop___024root* vlSelf) {
    ...
    vlSelf->seg = VL_RAND_RESET_I(8);
    vlSelf->led = VL_RAND_RESET_I(3);
    vlSelf->flag = VL_RAND_RESET_I(1);
    vlSelf->top__DOT__y = VL_RAND_RESET_I(3);
    vlSelf->top__DOT__i1__DOT__i = VL_RAND_RESET_I(32);
    ...
    vlSelf->__Vtrigrprev__TOP__top__DOT__y = VL_RAND_RESET_I(3);
