...
VL_ATTR_COLD void Vtop___024root___ctor_var_reset(Vtop___024root* vlSelf) {
    ...
    vlSelf->top__DOT__d_idu_io_inst_req_ready = VL_RAND_RESET_I(1);
    ...
    vlSelf->top__DOT__is_break_out = VL_RAND_RESET_I(1);
    vlSelf->top__DOT__b_ifu__DOT__state = VL_RAND_RESET_I(1);
    vlSelf->top__DOT__b_ifu__DOT__addrReg = VL_RAND_RESET_I(32);
    vlSelf->top__DOT__c_sram__DOT__state_ram = VL_RAND_RESET_I(1);
    vlSelf->top__DOT__c_sram__DOT__instReg = VL_RAND_RESET_I(32);
    vlSelf->top__DOT__c_sram__DOT__pcReg = VL_RAND_RESET_I(32);
    vlSelf->top__DOT__d_idu__DOT__state_idu = VL_RAND_RESET_I(1);
    ...
    vlSelf->top__DOT__h_data_control__DOT__datactrl_state = VL_RAND_RESET_I(1);
    vlSelf->top__DOT__h_data_control__DOT___io_alu_Req_bits_data2_T = VL_RAND_RESET_I(32);
    vlSelf->top__DOT__i_alu__DOT__state = VL_RAND_RESET_I(1);
    ...
    vlSelf->top__DOT__j_pc_next__DOT__state = VL_RAND_RESET_I(1);
