...
VL_ATTR_COLD void VMuxKeyInternal___024root__trace_init_sub__TOP__0(VMuxKeyInternal___024root* vlSelf, VerilatedFst* tracep) {
...
VL_ATTR_COLD void VMuxKeyInternal___024root__trace_init_top(VMuxKeyInternal___024root* vlSelf, VerilatedFst* tracep) {
    if (false && vlSelf) {}  // Prevent unused
    VMuxKeyInternal__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
...
VL_ATTR_COLD void VMuxKeyInternal___024root__trace_full_top_0(void* voidSelf, VerilatedFst::Buffer* bufp);
...
VL_ATTR_COLD void VMuxKeyInternal___024root__trace_full_sub_0(VMuxKeyInternal___024root* vlSelf, VerilatedFst::Buffer* bufp);
