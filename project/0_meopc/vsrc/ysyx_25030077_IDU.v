module ysyx_25030077_IDU(
  ...
  wire  isaddi = _isaddi_T_2 == 10'h13; // @[module.scala 269:64]
  wire  isxori = _isaddi_T_2 == 10'h213; // @[module.scala 270:64]
  wire  isori = _isaddi_T_2 == 10'h313; // @[module.scala 271:64]
  wire  isandi = _isaddi_T_2 == 10'h393; // @[module.scala 272:64]
  wire [15:0] _issrai_T_3 = {io_instruction[31:26],io_instruction[14:12],io_instruction[6:0]}; // @[Cat.scala 31:58]
  wire  issrai = _issrai_T_3 == 16'h4293; // @[module.scala 273:87]
  wire  issrli = _issrai_T_3 == 16'h293; // @[module.scala 274:87]
  wire  isslli = _issrai_T_3 == 16'h93; // @[module.scala 275:87]
  wire  issra = _issrai_T_3 == 16'h42b3; // @[module.scala 276:87]
  wire  issrl = _issrai_T_3 == 16'h2b3; // @[module.scala 277:87]
  wire  isbeq = _isaddi_T_2 == 10'h63; // @[module.scala 278:64]
  wire  isbne = _isaddi_T_2 == 10'he3; // @[module.scala 279:64]
  wire [16:0] _isadd_T_3 = {io_instruction[31:25],io_instruction[14:12],io_instruction[6:0]}; // @[Cat.scala 31:58]
  wire  isadd = _isadd_T_3 == 17'h33; // @[module.scala 280:87]
  wire  isxor = _isadd_T_3 == 17'h233; // @[module.scala 281:87]
  wire  isand = _isadd_T_3 == 17'h3b3; // @[module.scala 282:87]
  wire  isor = _isadd_T_3 == 17'h333; // @[module.scala 283:87]
  wire  issub = _isadd_T_3 == 17'h8033; // @[module.scala 284:87]
  wire  islui = io_instruction[6:0] == 7'h37; // @[module.scala 285:36]
  wire  isauipc = io_instruction[6:0] == 7'h17; // @[module.scala 286:38]
  wire  isjal = io_instruction[6:0] == 7'h6f; // @[module.scala 287:36]
  wire  isjalr = _isaddi_T_2 == 10'h67; // @[module.scala 288:65]
  wire  issw = _isaddi_T_2 == 10'h123; // @[module.scala 289:63]
  wire  isbge = _isaddi_T_2 == 10'h2e3; // @[module.scala 290:63]
  wire  isblt = _isaddi_T_2 == 10'h263; // @[module.scala 291:63]
  wire  isbltu = _isaddi_T_2 == 10'h363; // @[module.scala 292:63]
  wire  isbgeu = _isaddi_T_2 == 10'h3e3; // @[module.scala 293:63]
  wire  issb = _isaddi_T_2 == 10'h23; // @[module.scala 294:63]
  wire  issh = _isaddi_T_2 == 10'ha3; // @[module.scala 295:63]
  wire  islbu = _isaddi_T_2 == 10'h203; // @[module.scala 296:63]
  wire  islb = _isaddi_T_2 == 10'h3; // @[module.scala 297:63]
  wire  islw = _isaddi_T_2 == 10'h103; // @[module.scala 298:63]
  wire  islh = _isaddi_T_2 == 10'h83; // @[module.scala 299:63]
  wire  islhu = _isaddi_T_2 == 10'h283; // @[module.scala 300:63]
  wire  issll = _isadd_T_3 == 17'hb3; // @[module.scala 301:86]
  wire  isslt = _isadd_T_3 == 17'h133; // @[module.scala 302:88]
  wire  issltu = _isadd_T_3 == 17'h1b3; // @[module.scala 303:88]
  wire  issltiu = _isaddi_T_2 == 10'h193; // @[module.scala 304:65]
  wire  isslti = _isaddi_T_2 == 10'h113; // @[module.scala 305:65]
  wire  isebreak = io_instruction == 32'h100073; // @[module.scala 306:34]
  ...
  wire [2:0] _io_imm_type_T_17 = isandi ? 3'h1 : _io_imm_type_T_16; // @[Mux.scala 101:16]
  wire [2:0] _io_imm_type_T_18 = isori ? 3'h1 : _io_imm_type_T_17; // @[Mux.scala 101:16]
  wire [2:0] _io_imm_type_T_19 = isxori ? 3'h1 : _io_imm_type_T_18; // @[Mux.scala 101:16]
  ...
  wire [4:0] _io_rs1_T_30 = isandi ? addi_Rs1 : _io_rs1_T_29; // @[Mux.scala 101:16]
  wire [4:0] _io_rs1_T_31 = isori ? addi_Rs1 : _io_rs1_T_30; // @[Mux.scala 101:16]
  wire [4:0] _io_rs1_T_32 = isxori ? addi_Rs1 : _io_rs1_T_31; // @[Mux.scala 101:16]
  ...
  wire [4:0] _io_rd_T_24 = isandi ? addi_Rd : _io_rd_T_23; // @[Mux.scala 101:16]
  wire [4:0] _io_rd_T_25 = isori ? addi_Rd : _io_rd_T_24; // @[Mux.scala 101:16]
  wire [4:0] _io_rd_T_26 = isxori ? addi_Rd : _io_rd_T_25; // @[Mux.scala 101:16]
  ...
  wire [4:0] _io_ALU_ctrl_T_33 = isandi ? 5'h6 : _io_ALU_ctrl_T_32; // @[Mux.scala 101:16]
  wire [4:0] _io_ALU_ctrl_T_34 = isori ? 5'h3 : _io_ALU_ctrl_T_33; // @[Mux.scala 101:16]
  wire [4:0] _io_ALU_ctrl_T_35 = isxori ? 5'h4 : _io_ALU_ctrl_T_34; // @[Mux.scala 101:16]
  wire [4:0] _io_ALU_ctrl_T_36 = isaddi ? 5'h0 : _io_ALU_ctrl_T_35; // @[Mux.scala 101:16]
  ...
  wire [3:0] _io_pc_next_type_T_23 = isebreak ? 4'h4 : _io_pc_next_type_T_22; // @[Mux.scala 101:16]
  wire [3:0] _io_pc_next_type_T_24 = issh ? 4'h0 : _io_pc_next_type_T_23; // @[Mux.scala 101:16]
  wire [3:0] _io_pc_next_type_T_25 = issb ? 4'h0 : _io_pc_next_type_T_24; // @[Mux.scala 101:16]
  wire [3:0] _io_pc_next_type_T_26 = issw ? 4'h0 : _io_pc_next_type_T_25; // @[Mux.scala 101:16]
  wire [3:0] _io_pc_next_type_T_27 = isslli ? 4'h0 : _io_pc_next_type_T_26; // @[Mux.scala 101:16]
  wire [3:0] _io_pc_next_type_T_28 = issrli ? 4'h0 : _io_pc_next_type_T_27; // @[Mux.scala 101:16]
  wire [3:0] _io_pc_next_type_T_29 = issrai ? 4'h0 : _io_pc_next_type_T_28; // @[Mux.scala 101:16]
  wire [3:0] _io_pc_next_type_T_30 = isandi ? 4'h0 : _io_pc_next_type_T_29; // @[Mux.scala 101:16]
  wire [3:0] _io_pc_next_type_T_31 = isori ? 4'h0 : _io_pc_next_type_T_30; // @[Mux.scala 101:16]
  wire [3:0] _io_pc_next_type_T_32 = isxori ? 4'h0 : _io_pc_next_type_T_31; // @[Mux.scala 101:16]
  wire [3:0] _io_pc_next_type_T_33 = isaddi ? 4'h0 : _io_pc_next_type_T_32; // @[Mux.scala 101:16]
  wire [3:0] _io_pc_next_type_T_34 = islui ? 4'h0 : _io_pc_next_type_T_33; // @[Mux.scala 101:16]
  wire [3:0] _io_pc_next_type_T_35 = isauipc ? 4'h0 : _io_pc_next_type_T_34; // @[Mux.scala 101:16]
  wire [3:0] _io_pc_next_type_T_36 = isjalr ? 4'h2 : _io_pc_next_type_T_35; // @[Mux.scala 101:16]
  assign io_imm_type = isaddi ? 3'h1 : _io_imm_type_T_19; // @[Mux.scala 101:16]
  assign io_rs1 = isaddi ? addi_Rs1 : _io_rs1_T_32; // @[Mux.scala 101:16]
  assign io_rs2 = issw ? sltu_Rs2 : _io_rs2_T_17; // @[Mux.scala 101:16]
  assign io_rd = isaddi ? addi_Rd : _io_rd_T_26; // @[Mux.scala 101:16]
  assign io_data_control = isauipc ? 3'h1 : _io_data_control_T_25; // @[Mux.scala 101:16]
  assign io_ALU_ctrl = _io_ALU_ctrl_T_36[3:0]; // @[module.scala 424:15]
  assign io_pc_next_type = isjal ? 4'h1 : _io_pc_next_type_T_36; // @[Mux.scala 101:16]
endmodule