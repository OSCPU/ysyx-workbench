module ysyx_25030077_IDU(
  ...
  wire [4:0] addi_Rs1 = io_instruction[19:15]; // @[IDU.scala 29:32]
  wire [4:0] addi_Rd = io_instruction[11:7]; // @[IDU.scala 30:32]
  wire [4:0] sltu_Rs2 = io_instruction[24:20]; // @[IDU.scala 95:33]
  wire [9:0] _isaddi_T_2 = {io_instruction[14:12],io_instruction[6:0]}; // @[Cat.scala 31:58]
  wire  isaddi = _isaddi_T_2 == 10'h13; // @[IDU.scala 293:64]
  wire  isxori = _isaddi_T_2 == 10'h213; // @[IDU.scala 294:64]
  wire  isori = _isaddi_T_2 == 10'h313; // @[IDU.scala 295:64]
  wire  isandi = _isaddi_T_2 == 10'h393; // @[IDU.scala 296:64]
  wire [15:0] _issrai_T_3 = {io_instruction[31:26],io_instruction[14:12],io_instruction[6:0]}; // @[Cat.scala 31:58]
  wire  issrai = _issrai_T_3 == 16'h4293; // @[IDU.scala 297:87]
  wire  issrli = _issrai_T_3 == 16'h293; // @[IDU.scala 298:87]
  wire  isslli = _issrai_T_3 == 16'h93; // @[IDU.scala 299:87]
  wire  issra = _issrai_T_3 == 16'h42b3; // @[IDU.scala 300:87]
  wire  issrl = _issrai_T_3 == 16'h2b3; // @[IDU.scala 301:87]
  wire  isbeq = _isaddi_T_2 == 10'h63; // @[IDU.scala 302:64]
  wire  isbne = _isaddi_T_2 == 10'he3; // @[IDU.scala 303:64]
  wire [16:0] _isadd_T_3 = {io_instruction[31:25],io_instruction[14:12],io_instruction[6:0]}; // @[Cat.scala 31:58]
  wire  isadd = _isadd_T_3 == 17'h33; // @[IDU.scala 304:87]
  wire  isxor = _isadd_T_3 == 17'h233; // @[IDU.scala 305:87]
  wire  isand = _isadd_T_3 == 17'h3b3; // @[IDU.scala 306:87]
  wire  isor = _isadd_T_3 == 17'h333; // @[IDU.scala 307:87]
  wire  issub = _isadd_T_3 == 17'h8033; // @[IDU.scala 308:87]
  wire  islui = io_instruction[6:0] == 7'h37; // @[IDU.scala 309:36]
  wire  isauipc = io_instruction[6:0] == 7'h17; // @[IDU.scala 310:38]
  wire  isjal = io_instruction[6:0] == 7'h6f; // @[IDU.scala 311:36]
  wire  isjalr = _isaddi_T_2 == 10'h67; // @[IDU.scala 312:65]
  wire  issw = _isaddi_T_2 == 10'h123; // @[IDU.scala 313:63]
  wire  isbge = _isaddi_T_2 == 10'h2e3; // @[IDU.scala 314:63]
  wire  isblt = _isaddi_T_2 == 10'h263; // @[IDU.scala 315:63]
  wire  isbltu = _isaddi_T_2 == 10'h363; // @[IDU.scala 316:63]
  wire  isbgeu = _isaddi_T_2 == 10'h3e3; // @[IDU.scala 317:63]
  wire  issb = _isaddi_T_2 == 10'h23; // @[IDU.scala 318:63]
  wire  issh = _isaddi_T_2 == 10'ha3; // @[IDU.scala 319:63]
  wire  islbu = _isaddi_T_2 == 10'h203; // @[IDU.scala 320:63]
  wire  islb = _isaddi_T_2 == 10'h3; // @[IDU.scala 321:63]
  wire  islw = _isaddi_T_2 == 10'h103; // @[IDU.scala 322:63]
  wire  islh = _isaddi_T_2 == 10'h83; // @[IDU.scala 323:63]
  wire  islhu = _isaddi_T_2 == 10'h283; // @[IDU.scala 324:63]
  wire  issll = _isadd_T_3 == 17'hb3; // @[IDU.scala 325:86]
  wire  isslt = _isadd_T_3 == 17'h133; // @[IDU.scala 326:88]
  wire  issltu = _isadd_T_3 == 17'h1b3; // @[IDU.scala 327:88]
  wire  issltiu = _isaddi_T_2 == 10'h193; // @[IDU.scala 328:65]
  wire  isslti = _isaddi_T_2 == 10'h113; // @[IDU.scala 329:65]
  wire  iscsrrw = _isaddi_T_2 == 10'hf3; // @[IDU.scala 330:67]
  wire  iscsrrs = _isaddi_T_2 == 10'h173; // @[IDU.scala 331:67]
  wire  isebreak = io_instruction == 32'h100073; // @[IDU.scala 332:34]
  wire  isecall = io_instruction == 32'h73; // @[IDU.scala 333:34]
  wire  ismret = io_instruction == 32'h30200073; // @[IDU.scala 334:34]
  ...
  assign io_ALU_ctrl = _io_ALU_ctrl_T_38[3:0]; // @[IDU.scala 457:15]
