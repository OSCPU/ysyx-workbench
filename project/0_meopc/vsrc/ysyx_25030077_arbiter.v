module ysyx_25030077_arbiter(
  ...
  wire  _axi_ar_addr_T = state_reg == 2'h0; // @[arbiter.scala 72:42]
  wire  _axi_ar_addr_T_1 = state_reg == 2'h1; // @[arbiter.scala 73:42]
  wire [32:0] _axi_ar_addr_T_2 = io_rs1_data + io_imm; // @[arbiter.scala 73:67]
  wire [31:0] _axi_ar_addr_T_4 = _axi_ar_addr_T_1 ? _axi_ar_addr_T_2[31:0] : 32'h0; // @[Mux.scala 101:16]
  wire [31:0] axi_ar_addr = _axi_ar_addr_T ? io_pc : _axi_ar_addr_T_4; // @[Mux.scala 101:16]
  ...
  wire  axi_r_valid = io_axi_r_valid_mem | io_axi_r_valid_clint; // @[arbiter.scala 76:26]
  ...
  wire  _io_axi_aw_addr_mem_T = _axi_ar_addr_T_4 == 32'ha00003f8; // @[arbiter.scala 92:44]
  wire  _axi_aw_valid_T_1 = io_axi_r_valid_mem | io_axi_r_valid_clint; // @[arbiter.scala 96:74]
  wire  axi_aw_valid = _axi_ar_addr_T_1 & _axi_aw_valid_T_1; // @[Mux.scala 101:16]
  wire  axi_ar_valid = _axi_ar_addr_T ? io_ifu_valid : _axi_ar_addr_T_1 & axi_r_valid; // @[Mux.scala 101:16]
  wire [2:0] _axi_ar_strb_T_2 = _axi_ar_addr_T_1 ? io_r_mask : 3'h0; // @[Mux.scala 101:16]
  wire [2:0] axi_ar_strb = _axi_ar_addr_T ? 3'h6 : _axi_ar_strb_T_2; // @[Mux.scala 101:16]
  wire [31:0] axi_w_data = _axi_ar_addr_T_1 ? io_rs2_data : 32'h0; // @[Mux.scala 101:16]
  wire [2:0] axi_w_strb = _axi_ar_addr_T_1 ? io_w_mask : 3'h0; // @[Mux.scala 101:16]
  wire  _inst_reg_T_2 = _state_reg_T_1 & _axi_ar_addr_T; // @[arbiter.scala 151:50]
  ...
  assign io_axi_aw_addr_mem = _axi_ar_addr_T_4 == 32'ha00003f8 ? 32'h80000000 : _axi_ar_addr_T_4; // @[arbiter.scala 92:31]
  ...
  assign io_is_r = _axi_ar_addr_T | _axi_ar_addr_T_1 & io_r_valid_lsu; // @[Mux.scala 101:16]
  always @(posedge clock) begin
    if (reset) begin // @[arbiter.scala 68:28]
      state_reg <= 2'h0; // @[arbiter.scala 68:28]
    end else if (_axi_ar_addr_T) begin // @[Mux.scala 101:16]
      state_reg <= {{1'd0}, _state_reg_T_1};
    end else if (_axi_ar_addr_T_1) begin // @[Mux.scala 101:16]
