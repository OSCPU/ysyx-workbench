...
class alignas(VL_CACHE_LINE_BYTES) Vtop___024root final : public VerilatedModule {
  public:
    ...
    struct {
        ...
        CData/*0:0*/ top__DOT__b_ifu_io_sramReq_ready;
        CData/*0:0*/ top__DOT__c_sram_io_iduReq_ready;
        CData/*0:0*/ top__DOT__d_idu_io_ready;
        CData/*0:0*/ top__DOT__f_gpr_io_rd_Req_ready;
        CData/*0:0*/ top__DOT__f_gpr_io_pcnext_Req_ready;
