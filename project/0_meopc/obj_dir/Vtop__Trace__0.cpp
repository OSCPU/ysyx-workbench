...
void Vtop___024root__trace_chg_0_sub_0(Vtop___024root* vlSelf, VerilatedFst::Buffer* bufp) {
    ...
    if (VL_UNLIKELY((vlSelfRef.__Vm_traceActivity[1U]))) {
        ...
        bufp->chgBit(oldp+14,(vlSelfRef.ysyx_25030077_top__DOT__i1__DOT__addr_gen__DOT__addr_state));
        bufp->chgBit(oldp+15,(vlSelfRef.ysyx_25030077_top__DOT__i1__DOT__ifu__DOT__state));
