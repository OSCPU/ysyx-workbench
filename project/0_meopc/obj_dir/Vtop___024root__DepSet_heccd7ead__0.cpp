...
VL_INLINE_OPT void Vtop___024root___nba_sequent__TOP__0(Vtop___024root* vlSelf) {
    ...
    __Vfunc_top__DOT__g_mem__DOT__mem_data_read__2__Vfuncout = 0;
    ...
    } else if (((IData)(vlSelfRef.top__DOT__c_sram__DOT__validReg) 
                & (IData)(vlSelfRef.top__DOT__c_sram_io_mem_Req_ready))) {
                                                                             ...
                                                                             ((0x103U 
                                                                              ...
                                                                              ((0x83U 
                                                                               ...
                                                                               ((0x283U 
                                                                                ...
                                                                                == (IData)(vlSelfRef.top__DOT__d_idu__DOT___isaddi_T_2))
                                                                                 ? 5U
                                                                                 : 0U))))), vlSelfRef.top__DOT__f_gpr_io_rdata_rs1, vlSelfRef.top__DOT__f_gpr_io_rdata_rs2, vlSelfRef.top__DOT__e_imm_io_imm, __Vfunc_top__DOT__g_mem__DOT__mem_data_read__2__Vfuncout);
        vlSelfRef.top__DOT__g_mem__DOT__mem_data_Reg 
            = __Vfunc_top__DOT__g_mem__DOT__mem_data_read__2__Vfuncout;
    }
    if (vlSelfRef.reset) {
        vlSelfRef.top__DOT__c_sram__DOT__instReg = 0x413U;
    } else if (((IData)(vlSelfRef.top__DOT__b_ifu__DOT__reqQ__DOT__maybe_full) 
                & (IData)(vlSelfRef.top__DOT__b_ifu_io_sram_Req_ready))) {
    ...
    vlSelfRef.top__DOT__g_mem__DOT__validReg = ((1U 
                                                ...
                                                && (((IData)(vlSelfRef.top__DOT__c_sram__DOT__validReg) 
                                                     & (IData)(vlSelfRef.top__DOT__c_sram_io_mem_Req_ready)) 
                                                    | (IData)(vlSelfRef.top__DOT__g_mem__DOT___validReg_T_1)));
    if (vlSelfRef.reset) {
    ...
    vlSelfRef.top__DOT__i_alu__DOT___overflowAddBool_T 
        = (1U & ((vlSelfRef.top__DOT__h_data_control_io_data_1 
                  >> 0x1fU) ^ (IData)((vlSelfRef.top__DOT__i_alu__DOT__out33 
                                       >> 0x1fU))));
    vlSelfRef.top__DOT__f_gpr__DOT___validReg_T = ((IData)(vlSelfRef.top__DOT__g_mem__DOT__validReg) 
                                                   & (IData)(vlSelfRef.top__DOT__f_gpr_io_mem_Req_ready));
    vlSelfRef.top__DOT__g_mem__DOT___validReg_T_1 = 
        ((~ (IData)(vlSelfRef.top__DOT__f_gpr_io_mem_Req_ready)) 
         & (IData)(vlSelfRef.top__DOT__g_mem__DOT__validReg));
    vlSelfRef.top__DOT__c_sram_io_mem_Req_ready = (1U 
                                                   & ((~ (IData)(vlSelfRef.top__DOT__g_mem__DOT__validReg)) 
                                                      | (IData)(vlSelfRef.top__DOT__f_gpr_io_mem_Req_ready)));
    ...
    vlSelfRef.top__DOT__c_sram__DOT___validReg_T_1 
        = ((~ (IData)(vlSelfRef.top__DOT__c_sram_io_mem_Req_ready)) 
           & (IData)(vlSelfRef.top__DOT__c_sram__DOT__validReg));
    vlSelfRef.top__DOT__b_ifu_io_sram_Req_ready = (1U 
                                                   & ((~ (IData)(vlSelfRef.top__DOT__c_sram__DOT__validReg)) 
                                                      | (IData)(vlSelfRef.top__DOT__c_sram_io_mem_Req_ready)));
