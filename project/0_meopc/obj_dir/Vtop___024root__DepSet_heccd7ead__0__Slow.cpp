...
VL_ATTR_COLD void Vtop___024root___ctor_var_reset(Vtop___024root* vlSelf) {
    ...
    vlSelf->top__DOT__b_ifu_io_sramReq_ready = VL_RAND_RESET_I(1);
    vlSelf->top__DOT__c_sram_io_iduReq_ready = VL_RAND_RESET_I(1);
    vlSelf->top__DOT__d_idu_io_ready = VL_RAND_RESET_I(1);
    vlSelf->top__DOT__e_imm_io_imm = VL_RAND_RESET_I(32);
    vlSelf->top__DOT__f_gpr_io_rd_Req_ready = VL_RAND_RESET_I(1);
    vlSelf->top__DOT__f_gpr_io_pcnext_Req_ready = VL_RAND_RESET_I(1);
    vlSelf->top__DOT__f_gpr_io_rdata_rs1 = VL_RAND_RESET_I(32);
    vlSelf->top__DOT__f_gpr_io_rdata_rs2 = VL_RAND_RESET_I(32);
    vlSelf->top__DOT__g_mem_io_mem_data = VL_RAND_RESET_I(32);
    ...
    vlSelf->top__DOT__is_break_out_o = VL_RAND_RESET_I(1);
    ...
    vlSelf->top__DOT__d_idu__DOT___rs1_reg_T_12 = VL_RAND_RESET_I(5);
    vlSelf->top__DOT__d_idu__DOT___rs1_reg_T_25 = VL_RAND_RESET_I(5);
    vlSelf->top__DOT__d_idu__DOT___rs2_reg_T_12 = VL_RAND_RESET_I(5);
    vlSelf->top__DOT__d_idu__DOT___rd_reg_T_12 = VL_RAND_RESET_I(5);
    vlSelf->top__DOT__d_idu__DOT___rd_reg_T_24 = VL_RAND_RESET_I(5);
    vlSelf->top__DOT__d_idu__DOT___ALU_ctrl_reg_T_19 = VL_RAND_RESET_I(5);
    ...
    vlSelf->top__DOT__f_gpr__DOT___GEN_117 = VL_RAND_RESET_I(32);
    vlSelf->top__DOT__h_data_control__DOT___io_alu_Req_bits_data2_T = VL_RAND_RESET_I(32);
    vlSelf->top__DOT__i_alu__DOT__csr_data = VL_RAND_RESET_I(32);
    vlSelf->top__DOT__i_alu__DOT__out_reg = VL_RAND_RESET_I(32);
    vlSelf->top__DOT__i_alu__DOT__carry_reg = VL_RAND_RESET_I(1);
    vlSelf->top__DOT__i_alu__DOT__overflow_reg = VL_RAND_RESET_I(1);
    ...
    vlSelf->top__DOT__i_alu__DOT____VdfgRegularize_h4243b50f_0_0 = VL_RAND_RESET_I(5);
