...
#ifndef VERILATED_VYSYX_25020077_TOP___024ROOT_H_
#define VERILATED_VYSYX_25020077_TOP___024ROOT_H_  // guard
...
class alignas(VL_CACHE_LINE_BYTES) Vysyx_25020077_top___024root final : public VerilatedModule {
  public:
    ...
    struct {
        ...
        CData/*7:0*/ ysyx_25030077_top__DOT__i9__DOT__index;
    ...
    // CONSTRUCTORS
    Vysyx_25020077_top___024root(Vysyx_25020077_top__Syms* symsp, const char* v__name);
    ~Vysyx_25020077_top___024root();
    VL_UNCOPYABLE(Vysyx_25020077_top___024root);
